...
function template_user_list()
{
	...
	if (empty($template['users']))
	{
		echo '
				<tr>
					<td class="align_center" colspan="4">There are not any users added yet!</td>
				</tr>';
	}
	...
	foreach ($template['users'] as $user)
	{
		echo '
				<tr>
					<td>', $user['username'], '</td>
					<td class="span3 align_center">', $user['registered'], '</td>
					<td class="span2 align_center">', $user['admin'], '</td>
